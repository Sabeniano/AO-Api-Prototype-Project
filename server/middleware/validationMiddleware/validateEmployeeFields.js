...
exports.createFields = [
  ...
  body('birthday', 'must specify a valid date').exists().isISO8601().isBefore(new Date().toString()),
  ...
  body('phoneNumber', 'must specify a mobile phone number').exists().isNumeric().isMobilePhone('da-DK'),
