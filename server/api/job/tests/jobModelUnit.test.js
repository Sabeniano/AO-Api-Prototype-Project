...
describe('Job Model Unit Tests', () => {
  ...
  context('validation', () => {
    ...
    //  const newJob = new Job();
    //  newJob.validate((error) => {
    //    expect(error.errors).to.have.property('_Owner');
    //    done();
    //  });
    //});
  });
